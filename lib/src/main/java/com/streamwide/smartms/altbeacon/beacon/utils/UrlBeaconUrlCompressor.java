...
public class UrlBeaconUrlCompressor {
    ...
    private static final String EDDYSTONE_URL_REGEX = "^((?i)(http|https)://)(?i)(www\\.)?([0-9a-zA-Z_-]+(?:\\.[0-9a-zA-Z_-]+)*)(/?)([./0-9a-zA-Z_-]*)$";
     ...
     */
    @NonNull
    public static byte[] compress(@Nullable String urlString) throws MalformedURLException {
        ...
        if (urlString != null) {
            ...
            if (urlMatcher.matches()) {
                ...
                String protocol = rawProtocol.toLowerCase(Locale.getDefault());
                ...
                String hostname = rawHostname.toLowerCase(Locale.getDefault());
    ...
    @NonNull
    public static String uncompress(@NonNull byte[] compressedURL) {
