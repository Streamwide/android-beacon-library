 ...
 *
 * @lastModifiedOn Mon, 4 Nov 2024 14:21:18 +0100
 */
...
import com.streamwide.smartms.altbeacon.bluetooth.BleAdvertisement;
import com.streamwide.smartms.altbeacon.bluetooth.Pdu;
...
public class BeaconParser implements Serializable {
     ...
     * this parser
     */
    public BeaconParser(@Nullable String identifier) {
     ...
     *
     * @param beaconLayout : beacon layout
     ...
     */
    @Nullable
    public BeaconParser setBeaconLayout(@NonNull String beaconLayout) {
        mBeaconLayout = beaconLayout;
        Logger.debug(TAG, "Parsing beacon layout: " + beaconLayout);
     ...
     */
    public boolean addExtraDataParser(@Nullable BeaconParser extraDataParser) {
     ...
     * https://www.bluetooth.org/en-us/specification/assigned-numbers/company-identifiers
     */
    public void setHardwareAssistManufacturerCodes(@Nullable int[] manufacturers) {
     ...
     * @param enabled
     */
    public void setAllowPduOverflow(@Nullable Boolean enabled) {
    ...
    @Nullable
    protected Beacon fromScanData(@Nullable byte[] bytesToProcess, int rssi, @Nullable BluetoothDevice device, long timestampMs, @NonNull Beacon beacon) {
        ...
        if (pdusToParse.size() == 0) {
            ...
            for (Pdu pduToParse : pdusToParse) {
                ...
                if (getServiceUuid() == null || getServiceUuid() == -1) {
                    ...
                    if (serviceUuidBytes != null && byteArraysMatch(bytesToProcess, startByte + mServiceUuidStartOffset, serviceUuidBytes)) {
                        if (mMatchingBeaconTypeCodeEndOffset != null) {
                            if (byteArraysMatch(bytesToProcess, startByte + mMatchingBeaconTypeCodeStartOffset, typeCodeBytes)) {
                                patternFound = true;
                            }
                    ...
                    if (getServiceUuid() == null) {
                        ...
                        if (LogManager.isVerboseLoggingEnabled()) {
                            ...
                            LogManager.d(TAG, "This is not a matching Beacon advertisement. Was expecting %s at offset %d and %s at offset %d.  "
                                    ...
                                    serviceUuidBytes != null ? byteArrayToString(serviceUuidBytes) : "",
        ...
        if (parseSucceeded) {
            ...
            if (device != null) {
                ...
                try {
                    ...
                    LogManager.e(ex, TAG, "SecurityException : Cannot retrieve device name from scan data");
     ...
     */
    @Nullable
    public byte[] getBeaconAdvertisementData(@Nullable Beacon beacon) {
    ...
    @Nullable
    public BeaconParser setMatchingBeaconTypeCode(@Nullable Long typeCode) {
    ...
    protected static @NonNull String bytesToHex(@NonNull byte[] bytes) {
    ...
    public static class BeaconLayoutException extends RuntimeException {
        public BeaconLayoutException(@Nullable String s) {
            super(s);
        }
    }
    ...
    public static byte[] longToByteArray(long longValue, int length, boolean bigEndian) {
        ...
        for (int i = 0; i < length; i++) {
            ...
            long shift = (length - adjustedI - 1) * 8L;
    ...
    public boolean equals(Object o) {
        ...
        try {
            that = (BeaconParser) o;
            if (that != null && that.mBeaconLayout != null && that.mBeaconLayout.equals(this.mBeaconLayout)) {
