...
import com.streamwide.smartms.altbeacon.beacon.service.DetectionTracker;
...
public class CycledLeScannerForLollipop extends CycledLeScanner {
    ...
    protected long mBackgroundLScanStartTime = 0L;
    private long mBackgroundLScanFirstDetectionTime = 0;
    protected boolean mMainScanCycleActive = false;
    private final BeaconManager mBeaconManager;
    private final PowerManager mPowerManager;

    public CycledLeScannerForLollipop(@NonNull Context context, long scanPeriod, long betweenScanPeriod, boolean backgroundFlag, @NonNull CycledLeScanCallback cycledLeScanCallback, @NonNull BluetoothCrashResolver crashResolver) {
            ...
            if (Build.MANUFACTURER.equalsIgnoreCase("samsung") && !mPowerManager.isInteractive()) {
                ...
                if (Build.MANUFACTURER.equalsIgnoreCase("samsung")) {
                    ...
                    if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.TIRAMISU) {
                        mContext.getApplicationContext().registerReceiver(mSamsungScreenOffReceiver, filter, RECEIVER_NOT_EXPORTED);
                    } else {
    ...
    public void stop() {
        ...
        try { mContext.getApplicationContext().unregisterReceiver(mSamsungScreenOffReceiver); }
        catch (IllegalArgumentException e) {
            LogManager.e(e, TAG, "Failed to unregister SamsungScreenOffReceiver");
        }
    }
